...
from collabllm.vanilla_synthetic import generate_singleturn_dataset
...
def data_engine(args):
    ...
    with concurrent.futures.ThreadPoolExecutor(
        ...
        for example in pending_examples:
            ...
            # Submit generate_singleturn_dataset using kwargs
            future = executor.submit(
                generate_singleturn_dataset,
                task_desc=task_desc,
