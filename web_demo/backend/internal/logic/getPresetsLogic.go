...
// Get preset prompts
func NewGetPresetsLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GetPresetsLogic {
	return &GetPresetsLogic{
...
func (l *GetPresetsLogic) GetPresets() (resp *types.PresetsResp, err error) {
	presets := []types.PresetPrompt{
		{
			Id:          "socratic_base",
			Name:        "苏格拉底引导（基础版）",
	...
	return &types.PresetsResp{Presets: presets}, nil
}
